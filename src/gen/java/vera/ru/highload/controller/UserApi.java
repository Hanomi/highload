...
public interface UserApi {
    ...
    default Mono<ResponseEntity<UserDTO>> _userGetIdGet(
        ...
        return userGetIdGet(id, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<UserDTO>> userGetIdGet(String id,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<UserRegisterPost200ResponseDTO>> _userRegisterPost(
        ...
        return userRegisterPost(userRegisterPostRequestDTO, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<UserRegisterPost200ResponseDTO>> userRegisterPost(Mono<UserRegisterPostRequestDTO> userRegisterPostRequestDTO,  final ServerWebExchange exchange) {
        Mono<Void> result = Mono.empty();
        exchange.getResponse().setStatusCode(HttpStatus.NOT_IMPLEMENTED);
        for (MediaType mediaType : exchange.getRequest().getHeaders().getAccept()) {
            if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default Mono<ResponseEntity<Flux<UserDTO>>> _userSearchGet(
        ...
        return userSearchGet(firstName, lastName, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<Flux<UserDTO>>> userSearchGet(String firstName, String lastName,  final ServerWebExchange exchange) {
        Mono<Void> result = Mono.empty();
        exchange.getResponse().setStatusCode(HttpStatus.NOT_IMPLEMENTED);
        for (MediaType mediaType : exchange.getRequest().getHeaders().getAccept()) {
            if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
