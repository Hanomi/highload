...
public interface DialogApi {
    ...
    default Mono<ResponseEntity<Flux<DialogMessageDTO>>> _dialogUserIdListGet(
        @Parameter(name = "user_id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("user_id") String userId,
        @Parameter(hidden = true) final ServerWebExchange exchange
    ) {
        return dialogUserIdListGet(userId, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<Flux<DialogMessageDTO>>> dialogUserIdListGet(String userId,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> _dialogUserIdSendPost(
        @Parameter(name = "user_id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("user_id") String userId,
        ...
        return dialogUserIdSendPost(userId, dialogUserIdSendPostRequestDTO, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<Void>> dialogUserIdSendPost(String userId, Mono<DialogUserIdSendPostRequestDTO> dialogUserIdSendPostRequestDTO,  final ServerWebExchange exchange) {
        Mono<Void> result = Mono.empty();
        exchange.getResponse().setStatusCode(HttpStatus.NOT_IMPLEMENTED);
