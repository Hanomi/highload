...
public interface PostApi {
    ...
    default Mono<ResponseEntity<String>> _postCreatePost(
        ...
        return postCreatePost(postCreatePostRequestDTO, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<String>> postCreatePost(Mono<PostCreatePostRequestDTO> postCreatePostRequestDTO,  final ServerWebExchange exchange) {
    ...
    default Mono<ResponseEntity<Void>> _postDeleteIdPut(
        @Parameter(name = "id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("id") String id,
        @Parameter(hidden = true) final ServerWebExchange exchange
    ) {
        return postDeleteIdPut(id, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<Void>> postDeleteIdPut(String id,  final ServerWebExchange exchange) {
        Mono<Void> result = Mono.empty();
        exchange.getResponse().setStatusCode(HttpStatus.NOT_IMPLEMENTED);
    ...
    default Mono<ResponseEntity<Flux<PostDTO>>> _postFeedGet(
        ...
        return postFeedGet(offset, limit, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<Flux<PostDTO>>> postFeedGet(BigDecimal offset, BigDecimal limit,  final ServerWebExchange exchange) {
        Mono<Void> result = Mono.empty();
        exchange.getResponse().setStatusCode(HttpStatus.NOT_IMPLEMENTED);
        for (MediaType mediaType : exchange.getRequest().getHeaders().getAccept()) {
            if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default Mono<ResponseEntity<PostDTO>> _postGetIdGet(
        @Parameter(name = "id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("id") String id,
        @Parameter(hidden = true) final ServerWebExchange exchange
    ) {
        return postGetIdGet(id, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<PostDTO>> postGetIdGet(String id,  final ServerWebExchange exchange) {
        Mono<Void> result = Mono.empty();
        exchange.getResponse().setStatusCode(HttpStatus.NOT_IMPLEMENTED);
        for (MediaType mediaType : exchange.getRequest().getHeaders().getAccept()) {
            if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
    ...
    default Mono<ResponseEntity<Void>> _postUpdatePut(
        ...
        return postUpdatePut(postUpdatePutRequestDTO, exchange);
    }

    // Override this method
    default  Mono<ResponseEntity<Void>> postUpdatePut(Mono<PostUpdatePutRequestDTO> postUpdatePutRequestDTO,  final ServerWebExchange exchange) {
        Mono<Void> result = Mono.empty();
        exchange.getResponse().setStatusCode(HttpStatus.NOT_IMPLEMENTED);
